...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$("#btnUpdate").click(function(){
			...
			frm.action = "<%=request.getContextPath()%>/timeLineEditEnd.action";
			frm.method = "post";
			frm.submit();
...
<div align="center"  style="margin-bottom: 0.2%; width: 50%; border: solid 0px red; margin-top: 30px;">
	...
	<form name="writeFrm" enctype="multipart/form-data">                
		<table id="table">
			...
			<!-- ==== #135. 비공개여부  -->
				<tr>
				<td align="center">
				<input type="radio" name="status" value="1" checked="checked"/> 공개
				<input type="radio" name="status"  value="2" /> 비공개
				</td>
				</tr>
			</table>
		<br/>
		...
		<div align="center" style="margin-bottom: 30px;">
			<button type="button" id="btnUpdate" style="background-color: #468EDE; color: #ffffff;">수정</button>
			<button type="button" onClick="javascript:history.back();" style="background-color: #E24B50; color: #ffffff;">취소</button>
		</div>
	</form>
	
<form name="editFrm">
		<input type="hidden" name="seq" value="${timelinevo.seq}">
